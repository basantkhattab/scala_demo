...
/**
 * The class Color holds a single color consisting of an alpha component (transparency) and red, green and blue components.
 * Color objects are immutable, so you can reuse them freely.
 *
